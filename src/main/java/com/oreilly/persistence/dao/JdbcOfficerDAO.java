...
public class JdbcOfficerDAO implements OfficerDAO {
    ...
    // Use for Reference: https://docs.spring.io/spring/docs/4.2.5.RELEASE/javadoc-api/org/springframework/jdbc/core/JdbcTemplate.html#queryForObject-java.lang.String-org.springframework.jdbc.core.RowMapper-java.lang.Object...-
    // rowMapper - object that will map one object per row
    // id in this case is arguments to bind to the query (leaving it to the PreparedStatement to guess the corresponding SQL type).
    @Override
